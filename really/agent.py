...
class Agent():
    ...
    Agent wrapper:
        @args
            ...
            output_shapes: specifiying the output shape of the model, default model does not need it for initialization
    ...
    def __init__(self, model, weights=None, input_shape=None, action_sampling_type='thompson', temperature=1, epsilon=0.95, value_estimate=False, output_shape=None):
        ...
        self.initialize_weights(self.model, self.input_shape)
